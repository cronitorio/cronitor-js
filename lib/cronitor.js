...
function Cronitor(apiKey, config={}) {
    ...
    this._api = {
        key: apiKey,
        version: config.apiVersion || process.env.CRONITOR_API_VERSION || null,
    ...
    this._api.axios.defaults.headers.common['User-Agent'] = 'cronitor-js'
    this._api.axios.defaults.headers.common['Authorization'] = 'Basic ' + new Buffer(apiKey + ':').toString('base64')
    if (this._api.version) this._api.axios.defaults.headers.common['Cronitor-Version'] = this._api.version
